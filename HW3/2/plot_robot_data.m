%% MATLAB script to plot robot simulation data
...
figure('Name', 'Robot Position and Orientation', 'NumberTitle', 'off');
...
sgtitle('Robot Position and Orientation');

%% Figure 2: Plot joint angles q1, q2, q3, q4
figure('Name', 'Robot Joint Angles', 'NumberTitle', 'off');
