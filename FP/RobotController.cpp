 ...
 * @brief Implementation of QP-based whole-body controller for biped robot.
 */
...
void RobotController::checkAndFixNan(std::vector<double>& torques) {
    bool replaced = false;
